...
const QuizPanel = ({ questions, topic = "Unknown", mode = "general", onComplete }: QuizPanelProps) => {
  ...
  const handleNext = async () => {
    if (isLastQuestion) {
      // Compute final answers deterministically from existing answers + current selection
      const finalAnswers = [...answers, selectedAnswer === currentQuestion.correctAnswer];
