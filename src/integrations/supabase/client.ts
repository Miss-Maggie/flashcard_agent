...
// Create a single Supabase client instance in the browser to avoid multiple GoTrueClient warnings
// and potential concurrent storage usage. In dev we keep the instance on globalThis so HMR
